...
class JatekterModel {
  #negyzetek = []; // Ebben vannak a Ngyzet obj-k
  #kovetkezo = false;
//   #szuloElem;
  o = "O";
  x = "X";
  constructor() {
      ...
      // Kilenc négyzet létrejön
      for (let index = 0; index < 9; index++) {
        this.#negyzetek.push(0);
      }

    }

    getJatekterTomb(){
    //visszadja azt a listát amiben a négyzet obj-k vannak
    return this.#negyzetek
    }
    setJatekterElem(index) {
        this.#negyzetek[index] = 1;
    }




//nem kell paraméter, mert csak létrejön, a viewnak kell CSAK paraméter hogy tudja h HOVA
